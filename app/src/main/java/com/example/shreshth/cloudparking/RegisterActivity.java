    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String regText=noText.getText().toString();
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                userMap.put("approaching",1);
                                userMap.put("description",regText);
                                float lat = -23.4456f;
                                float lng = 45.44334f;
                                GeoPoint gp = new GeoPoint((int)(0), (int)(0));
                                userMap.put("geopoint",gp);
                                userMap.put("priority",0);
                                userMap.put("title",name);
                                mFirestore.collection("sensors").document(user_id).set(userMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
